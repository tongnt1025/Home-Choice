...
<html>
   <head>
      ...
      <link rel="shortcut icon" href="./images/thiet-ke-logo-do-gia-dung-hc-shortcut-icon.jpg">
   ...
   <body>
      ...
      <div class="hero_area">
         ...
         <div style="margin-top:382px;z-index:10">
            <button class="prev" ><i class="fa-solid fa-angle-left"></i></i></button>
            <button class="next" ><i class="fa-solid fa-angle-right"></i></button>
         </div>
         <section class="slider_section  active" style="display:none;">
                        ...
                        <div class="row">
                           <div class="col-md-7 col-lg-6 ">
                              <div class="detail-box">
                                ...
                                <p>
                                Chúng tôi cung cấp các sản phẩm chất lượng cao và đa dạng như đồ dùng nhà bếp, thiết bị gia đình và đèn trang trí. Với cam kết về chất lượng và tiện ích, chúng tôi mang đến những sản phẩm đáng tin cậy và giá trị. Hãy đến và khám phá cửa hàng của chúng tôi để trang trí và nâng cấp không gian sống của bạn một cách đẹp và tiện nghi.
                                </p>
                                 <div class="btn-box">
      ...
      <script>
            const sliders=document.querySelectorAll(".slider_section");
            const next=document.querySelector(".next");
            const prev=document.querySelector(".prev");
            let indexActive=0;
            next.onclick=function(e){
           
             sliders[indexActive].classList.remove("active");
              indexActive++;
      ...
      <section class="why_section layout_padding">
         <div class="container">
            <div class="heading_container heading_center">
               <h2>
                  Vì sao nên mua hàng tại shop tôi
               </h2>
            </div>
            <div class="row">
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Vận chuyển nhanh chóng mang đến sự hài lòng cho bạn!
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                           Miễn phí ship - Tiện lợi, tiết kiệm và đáng tin cậy!
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                           Chất lượng tốt nhất - Mang đến sự hoàn hảo và tin cậy!
                        </p>
                     </div>
                  </div>
               </div>
